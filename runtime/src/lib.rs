...
const fn deposit(items: u32, bytes: u32) -> Balance {
    (items as Balance * 10 * MILLI_ATLA + (bytes as Balance) * (50 * MICRO_ATLA / 100)) / 10
}
...
parameter_types! {
    ...
    // signed config
    pub const SignedRewardBase: Balance = UNITS;
    pub const SignedFixedDeposit: Balance = 10 * MILLI_ATLA;
    pub const SignedDepositIncreaseFactor: Percent = Percent::from_percent(10);
    pub const SignedDepositByte: Balance = 10 * MILLI_ATLA;
...
parameter_types! {
    ...
    pub const FaucetAmount: Balance = 250 * UNITS;
...
use crate::areas::{CouncilCollective, EnsureRootOrHalfCouncil, TechnicalCollective};
